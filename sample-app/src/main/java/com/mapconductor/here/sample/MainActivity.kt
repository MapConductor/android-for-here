package com.mapconductor.here.sample
...
// HERE SDK credentials must be initialised before MapView is shown.
// Call the following in your Application class (or before setContent):
//
//   SDKNativeEngine.makeSharedInstance(
//       this,
//       SDKOptions("YOUR_ACCESS_KEY_ID", "YOUR_ACCESS_KEY_SECRET"),
//   )
...
private fun HomeScreen(onSelect: (Demo) -> Unit) {
    Scaffold { padding ->
        Column(
            ...
            Text("HERE Sample", style = MaterialTheme.typography.headlineSmall)
